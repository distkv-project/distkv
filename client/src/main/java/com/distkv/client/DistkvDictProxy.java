...
public class DistkvDictProxy {
  ...
  // Get a dict.
  public Map<String, String> get(String key) throws InvalidProtocolBufferException {
    DistkvRequest request = DistkvRequest.newBuilder()
        .setKey(key)
    ...
    DictProtocol.DistKVDict distKVDict =
        response.getResponse().unpack(DictGetResponse.class).getDict();
  ...
  public String getItem(String key, String itemKey) throws InvalidProtocolBufferException {
  ...
  public String popItem(String key, String itemKey) throws InvalidProtocolBufferException {
