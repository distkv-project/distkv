package com.distkv.dst.test.client.commandlinetool;

import com.distkv.dst.client.DstClient;
import com.distkv.dst.client.commandlinetool.CommandExecutorHandler;
...
public class DstCommandExecutorHandlerTest extends BaseTestSupplier {
  ...
  public void testMain() {
    ...
    dstParsedResult = dstParser.parse(command);
    Assert.assertEquals(CommandExecutorHandler.
            slistGetMember(dstClient, dstParsedResult), "22");
