...
public class ListRpcTestUtil {
    ...
    public static ListProtocol.PutResponse putResponseBuilder(ListProtocol.PutRequest.Builder builder,ProxyOnClient<DstListService> setProxy){
        ListProtocol.PutRequest build = builder.build();
        return setProxy.getService().put(build);
    }

    public static ListProtocol.GetResponse getResponseBuilder(ListProtocol.GetRequest.Builder builder,ProxyOnClient<DstListService> setProxy){
            ListProtocol.GetRequest build = builder.build();
            return setProxy.getService().get(build);
    }

    public static ListProtocol.DelResponse delResponseBuilder(ListProtocol.DelRequest.Builder builder,ProxyOnClient<DstListService> setProxy){
            ListProtocol.DelRequest build = builder.build();
            return setProxy.getService().del(build);
    }

    public static ListProtocol.LPutResponse lputResponseBuilder(ListProtocol.LPutRequest.Builder builder,ProxyOnClient<DstListService> setProxy){
            ListProtocol.LPutRequest build = builder.build();
            return setProxy.getService().lput(build);
    }

    public static ListProtocol.RPutResponse rputResponseBuilder(ListProtocol.RPutRequest.Builder builder,ProxyOnClient<DstListService> setProxy){
            ListProtocol.RPutRequest build = builder.build();
            return setProxy.getService().rput(build);
    }

    public static ListProtocol.LDelResponse ldelResponseBuilder(ListProtocol.LDelRequest.Builder builder,ProxyOnClient<DstListService> setProxy){
            ListProtocol.LDelRequest build = builder.build();
            return setProxy.getService().ldel(build);
    }

    public static ListProtocol.RDelResponse rdelResponseBuilder(ListProtocol.RDelRequest.Builder builder,ProxyOnClient<DstListService> setProxy){
