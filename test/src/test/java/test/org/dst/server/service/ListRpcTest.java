...
public class ListRpcTest extends BaseTestSupplier{
    ...
    public void testPutAndGet() {
        try(ProxyOnClient<DstListService> proxy = new ProxyOnClient<>(DstListService.class)) {
            ...
            ListProtocol.PutResponse putResponse = ListRpcTestUtil.putResponseBuilder(putRequest,proxy);
            ...
            ListProtocol.GetResponse getResponse = ListRpcTestUtil.getResponseBuilder(getRequest,proxy);
    ...
    public void testDel() {
        try(ProxyOnClient<DstListService> proxy = new ProxyOnClient<>(DstListService.class)) {
            ...
            ListProtocol.DelResponse delResponse = ListRpcTestUtil.delResponseBuilder(delRequest, proxy);
            Assert.assertEquals(CommonProtocol.Status.OK, delResponse.getStatus());

            //KEY_NOT_FOUND
            delRequest.setKey("k2");
            ListProtocol.DelResponse delResponse2 = ListRpcTestUtil.delResponseBuilder(delRequest, proxy);
    ...
    public void testLPut() {
        try(ProxyOnClient<DstListService> proxy = new ProxyOnClient<>(DstListService.class)) {
            ...
            ListProtocol.LPutResponse lputResponse = ListRpcTestUtil.lputResponseBuilder(lputRequest, proxy);
            ...
            getRequest.setKey("k1");
            ListProtocol.GetResponse getResponse = ListRpcTestUtil.getResponseBuilder(getRequest,proxy);
            Assert.assertEquals(ImmutableList.of("v3","v4","v0","v1","v2"), getResponse.getValuesList());
            ...
            ListProtocol.LPutResponse lputResponse2 = ListRpcTestUtil.lputResponseBuilder(lputRequest, proxy);
    ...
    public void testRPut() {
        try(ProxyOnClient<DstListService> proxy = new ProxyOnClient<>(DstListService.class)) {
            ...
            ListProtocol.RPutResponse rputResponse = ListRpcTestUtil.rputResponseBuilder(rputRequest, proxy);
            ...
            getRequest.setKey("k1");
            ListProtocol.GetResponse getResponse = ListRpcTestUtil.getResponseBuilder(getRequest,proxy);
            Assert.assertEquals(ImmutableList.of("v0","v1","v2","v3","v4"), getResponse.getValuesList());
            ...
            ListProtocol.RPutResponse rputResponse2 = ListRpcTestUtil.rputResponseBuilder(rputRequest, proxy);
    ...
    public void testLDel() {
        try(ProxyOnClient<DstListService> proxy = new ProxyOnClient<>(DstListService.class)) {
            ...
            ListProtocol.LDelResponse ldelResponse = ListRpcTestUtil.ldelResponseBuilder(ldelRequest, proxy);
            ...
            ldelRequest.setValues(1);
            ListProtocol.LDelResponse ldelResponse2 = ListRpcTestUtil.ldelResponseBuilder(ldelRequest, proxy);
    ...
    public void testRDel() {
        try(ProxyOnClient<DstListService> proxy = new ProxyOnClient<>(DstListService.class)) {
            ...
            ListProtocol.RDelResponse rdelResponse = ListRpcTestUtil.rdelResponseBuilder(rdelRequest, proxy);
            ...
            rdelRequest.setValues(1);
            ListProtocol.RDelResponse rdelResponse2 = ListRpcTestUtil.rdelResponseBuilder(rdelRequest, proxy);
