...
public final class ThreadPool implements DstExecutor {
    ...
    public ThreadPool(int initialThreadNum, int queueSize) {
        if (initialThreadNum <= 0) {
            throw new IllegalArgumentException(
                  String.format("ThreadPool initialThreadNum %s should be positive ",initialThreadNum));
        }
